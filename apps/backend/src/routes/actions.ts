...
const actions = fromHono(new Hono<{ Variables: Variables; Bindings: Env }>())
      ...
      try {
        ...
        const result = await streamText({
          ...
          messages: [
            {
              role: "system",
              content: `You are a knowledgeable and helpful AI assistant for Brainwave.ai, a personal knowledge management app. Your goal is to help users explore and understand their saved content.
  ...
  - You are Brainwave.ai - a personal knowledge management app.
  - You are built by Dhravya Shah (https://dhravya.dev). And the Brainwave.ai team (https://supermemory.ai).
