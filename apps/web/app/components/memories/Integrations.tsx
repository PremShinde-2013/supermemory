			...
			<DialogContent className="sm:max-w-md">
				{integration.id === "xBookmarks" && !extensionPresent ? (
					<div className="text-center">
						...
						<DialogDescription>
							Please install the Brainwave.ai extension to connect with X
						</DialogDescription>
					...
					<div className="text-center">
						...
						<DialogDescription className="mt-4">
							...
							and enjoy Brainwave.ai! (You might need to reload to see the changes!)
						</DialogDescription>
						<Button variant="outline" onClick={onCancel} className="mt-4">
							Cancel
						</Button>
		...
		<div className="container mx-auto px-4 py-8 md:py-16 max-w-full overflow-hidden">
			<div className="mb-8 md:mb-12 text-center">
				...
				<p className="mt-3 text-base md:text-lg text-neutral-600 dark:text-neutral-400">
					Connect your favorite platforms to import your content into Brainwave.ai
				</p>
			</div>
