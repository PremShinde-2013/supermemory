	...
	return (
		<>
			<a
				...
				className="text-gray-950 data-[hover]:text-gray-950/75" rel="noreferrer"
			>
...
function Copyright() {
	return (
		<div className="text-sm/6 text-gray-950 dark:text-gray-100">
			&copy; {new Date().getFullYear()} Brainwave.ai, Inc.
		</div>
	);
}
								...
								<div className="col-span-2 flex">
									<PlusGridItem className="pt-6 lg:pb-6">
										...
										<p className="text-gray-500">
											Brainwave.ai is a free, open-source AI knowlege platform.
										</p>
									</PlusGridItem>
								</div>
