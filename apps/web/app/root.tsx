...
export const meta: MetaFunction = () => {
	const title = "Brainwave.ai | ai second brain for all your saved content";
	const description =
		"Brainwave.ai is your AI-powered second brain that helps you organize, search and understand all your saved content from across the web. Save articles, tweets, documents and more in one searchable place.";
	...
	return [
		...
		{ name: "description", content: description },
		{
			name: "keywords",
			content:
				"Brainwave, ai, second brain, bookmark manager, note taking app, ai bookmarking, ai note taking, ai saved content, ai saved articles, ai saved tweets, ai saved documents",
		},
