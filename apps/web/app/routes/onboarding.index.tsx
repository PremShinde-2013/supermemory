...
export default function Onboarding() {
	...
	return (
		...
		>
			...
			>
				<Logo className="h-24 w-24" /> Brainwave.ai
			</motion.div>
			...
			>
				<h1 className="text-xl font-geist font-medium">Welcome to Brainwave.ai</h1>
				<p className="text-base font-geist max-w-md text-center font-light text-gray-200">
					Brainwave.ai is the universal engine for your knowledge.
				</p>
			</motion.div>
